...
func (c *queryClient) UnbondingEntries(ctx context.Context, in *QueryUnbondingEntriesRequest, opts ...grpc.CallOption) (*QueryUnbondingEntriesResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_UnbondingEntries_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) AllDelegations(ctx context.Context, in *QueryAllDelegationsRequest, opts ...grpc.CallOption) (*QueryAllDelegationsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_AllDelegations_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) UnbondingEntries(context.Context, *QueryUnbondingEntriesRequest) (*QueryUnbondingEntriesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UnbondingEntries not implemented")
}
func (UnimplementedQueryServer) AllDelegations(context.Context, *QueryAllDelegationsRequest) (*QueryAllDelegationsResponse, error) {
...
func _Query_UnbondingEntries_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_UnbondingEntries_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_AllDelegations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_AllDelegations_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
