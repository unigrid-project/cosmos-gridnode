...
const (
	Msg_DelegateTokens_FullMethodName   = "/cosmossdkgridnode.gridnode.Msg/DelegateTokens"
	Msg_UndelegateTokens_FullMethodName = "/cosmossdkgridnode.gridnode.Msg/UndelegateTokens"
)
